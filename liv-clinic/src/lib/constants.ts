...
export const TREATMENTS = {
  ...
  lifting: {
    ...
    onda: {
      ...
      name: '온다',
      nameEn: 'ONDA',
      tagline: '마이크로웨이브 컨투어링',
      shortDesc: '2.45GHz 마이크로웨이브로 지방 감소와 탄력 개선을 동시에',
      heroImage: '/images/treatments/onda.png',
      description: '온다(ONDA Coolwaves)는 이탈리아 DEKA사의 2.45GHz 마이크로웨이브 장비입니다. 마이크로웨이브 에너지가 피하지방층에 선택적으로 흡수되어 지방세포의 세포막을 손상시키고, 손상된 지방은 대식세포에 의해 서서히 제거됩니다. 동시에 진피층에는 열 자극이 전달되어 콜라겐 재생을 유도합니다.',
      benefits: [
        { title: '마이크로웨이브 방식', desc: '2.45GHz 마이크로웨이브가 피하지방층에 선택적으로 흡수' },
        { title: '두 층에 동시 작용', desc: '에너지의 약 20%는 진피층, 약 80%는 피하지방층에 작용' },
        { title: '접촉 냉각', desc: '약 5°C의 접촉 냉각으로 표피를 보호하면서 깊은 층을 가열' },
        { title: '얼굴과 바디', desc: '얼굴·이중턱부터 복부·허벅지까지 부위별로 적용 가능' },
      ],
      process: [
        { step: 1, title: '상담', desc: '피부 및 피하지방 상태 확인, 시술 부위 결정' },
        { step: 2, title: '세안', desc: '메이크업 제거 및 피부 정돈' },
        { step: 3, title: '준비', desc: '시술 부위 표시 및 시술 준비' },
        { step: 4, title: '시술', desc: '마이크로웨이브 핸드피스로 부위별 시술' },
        { step: 5, title: '마무리', desc: '시술 부위 정돈 및 애프터케어 안내' },
      ],
      duration: '얼굴 15-30분 / 바디 부위당 약 10분',
      anesthesia: '마취 불필요',
      recovery: '다운타임 없음 (시술 직후 일상생활 가능)',
      results: '4-12주에 걸쳐 점진적으로 나타남 (개인차 있음)',
      targetAreas: ['얼굴(볼·턱선)', '이중턱', '복부', '옆구리', '허벅지', '팔'],
      idealFor: [
        '탄력 저하와 국소 지방이 함께 있는 분',
        '다운타임 없이 개선을 원하는 분',
        '얼굴과 바디를 함께 관리하고 싶은 분',
      ],
      cautions: [
        '임신 중이거나 수유 중인 경우 상담 시 반드시 알려주세요',
        '심박조율기, 체내 금속 이식물을 보유한 경우 상담 시 반드시 알려주세요',
        '시술 부위에 염증, 감염, 상처가 있는 경우 상담 시 반드시 알려주세요',
        '조절되지 않는 당뇨 등 기저질환이 있는 경우 상담 시 반드시 알려주세요',
      ],
      faqs: [
        { q: '온다는 고주파(RF) 시술인가요?', shortA: '아니요. 온다는 2.45GHz 마이크로웨이브를 사용합니다.', a: '아니요. 온다는 2.45GHz 마이크로웨이브 에너지를 사용하는 장비입니다. RF(고주파), HIFU(초음파)와는 에너지의 종류와 주로 작용하는 층이 다릅니다.' },
        { q: '아픈가요? 마취가 필요한가요?', shortA: '마취 없이 진행하며, 따뜻한 마사지와 유사한 느낌으로 보고됩니다.', a: '온다는 마취 없이 진행합니다. 시술 중 느낌은 따뜻한 마사지와 유사한 수준으로 보고되며, 핸드피스의 접촉 냉각(약 5°C)이 피부 표면을 보호합니다.' },
        { q: '효과는 언제 나타나나요?', shortA: '즉각적이지 않고 4~12주에 걸쳐 점진적으로 나타납니다.', a: '온다의 효과는 즉각적으로 나타나지 않습니다. 손상된 지방이 대식세포에 의해 서서히 제거되면서 4-12주에 걸쳐 점진적으로 나타나며, 개인차가 있습니다.' },
      ],
      relatedTreatments: ['inmode', 'density', 'thermage'],
    },
    density: {
      id: 'density',
      category: 'lifting',
