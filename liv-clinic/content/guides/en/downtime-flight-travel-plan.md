...
## Downtime by treatment: time at the clinic, recovery and return visits

The table combines LIV's treatment pages (time, anesthesia, recovery) with the international patients page (which treatments need a return visit).
...
## What this site can, and cannot, tell you about flying
...
Both itineraries are time layouts, not medical advice. They assume you booked before flying (steps below) and that your appointment falls inside clinic hours: Monday to Friday 10:00–19:00, Saturday 10:00–16:00, closed on Sunday (Korea time).

| Day | Time | Plan |
|---|---|---|
| Day 1 | Morning | Land at Incheon (ICN). AREX train or limousine bus to Sinsa Station about 70–90 minutes, taxi about 60; from Gimpo (GMP) about 40 minutes by taxi or subway. |
| Day 1 | Early afternoon | Drop your bags. The clinic is a 1-minute walk from Sinsa Station Exit 4 (Line 3), next to Garosu-gil. |
| Day 1 | Afternoon | Consultation with the surgeon (interpreter if requested) → numbing cream about 30 minutes where used → treatment (Botox 10–20 minutes, Thermage FLX 45–60, Ultherapy Prime 60–90). Same day, no hospitalization. |
| Day 1 | Evening | A quiet evening near your hotel, following the written aftercare guide in English. |
| Day 2 | Morning | Free time. |
| Day 2 | Afternoon | Departure slot — see the note under itinerary B. |

## Model itinerary B: 3 days / 2 nights
...
1. **Contact the clinic** in English on WhatsApp (+82 10-6888-2773), the live chat on this site or the [contact form](/contact). No agency or broker, no deposit; replies within one business day.
2. **Remote consultation and quote.** Send your concerns and photos; the clinic suggests suitable treatments and a clear price estimate (see the [price list](/pricing)).
3. **Schedule your visit** on a date and time that fits your travel plans — include your flight times.
...
Most non-surgical lifting and anti-aging treatments take about 30–90 minutes, are done in a single day and require no hospitalization. Ultherapy Prime and Thermage FLX are completed in one session with no revisit needed. For a thread lift, an optional check-up after one week is recommended but not required.

### Do I need to come back to the clinic before I leave?

Not for Ultherapy Prime, Thermage FLX, Botox, filler or skin boosters. A thread lift has an optional check about one week later, which can be a remote photo check.

### What aftercare is possible once I am home?

You can send photos via chat or messenger and the clinic will review your progress and guide your aftercare. A written aftercare guide is provided in English, Japanese and Chinese.

### Can I be treated on the same day as my consultation?

In most cases, yes. Most treatments take 30 to 90 minutes with no hospitalization, so after the in-person consultation you are usually treated the same day.

## Before you book

Which treatment suits you, and when you can fly, are decided with the surgeon at the consultation. Send your dates and flight times via the [international patients page](/international) or the [contact form](/contact) — the clinic replies within one business day.
