...
## How pico laser tattoo removal works at LIV

LIV removes tattoos with the Lucas pico laser. A picosecond pulse is about 1,000 times shorter than that of a conventional nanosecond laser, so the ink is shattered into finer particles with less heat build-up in the surrounding skin. The fragments are then absorbed by the body's immune cells (macrophages) and cleared through the lymphatic system — which is why removal takes a series of sessions rather than one visit.
...
## Tattoo removal cost in Seoul: LIV's published prices

These are the prices LIV publishes on the [tattoo removal page](/laser/tattoo) (the [price list](/pricing) covers the clinic's other treatments). Tattoo removal is priced per area, per session. The CO2 laser rows sit in the same section but are for moles, flat warts and age spots, not tattoo ink — for a tattoo, the first line is the one that matters.

| Treatment | Basis | Price (per session) |
|---|---|---|
| Tattoo removal laser (Lucas pico laser) | Per area | KRW 50,000~ |
| CO2 laser | Diameter ≤ 3 mm (1 spot) | KRW 10,000~ |
| CO2 laser | 3 mm < diameter ≤ 5 mm (1 spot) | KRW 30,000~ |
| CO2 laser | Diameter > 5 mm (1 spot) | KRW 50,000~ |
| CO2 laser | Full face (50+ spots) | KRW 500,000~ |
| CO2 laser | Full neck (50+ spots) | KRW 500,000~ |
...
You can come in for a consultation without committing to treatment. The 1:1 consultation fee is KRW 10,000 (about US$7 at the same reference rate); if you go ahead with treatment the same day, it is deducted in full from the treatment cost. The surgeon examines the tattoo and recommends a plan; you can take your time deciding.
...
## Can I start tattoo removal on holiday? Fitting the sessions around your trip
...
With 6–8 weeks between sessions, the next one falls after most trips end. How you continue — on a later visit to Seoul, or in some other way — is something to agree with the surgeon at the first consultation. Between sessions you are not on your own: after you fly home you can send photos through WhatsApp or the live chat, the clinic reviews how the area is healing and answers questions, and you receive a written aftercare guide in English.

## Booking from abroad, without an agency

There is no broker and no deposit: you message the clinic directly and get a quote before you travel. Enquiries are answered within one business day.

1. **Contact the clinic** on WhatsApp (+82 10-6888-2773) or the live chat on this site, in English; the [contact form](/contact) also works.
2. **Remote consultation and quote.** Send a few clear photos of the tattoo and say what you want removed; the clinic suggests a plan and a price estimate.
3. **Schedule your visit.** Choose a date and time that fits your itinerary.
4. **Visit and same-day treatment.** Meet the surgeon for the in-person consultation, then have the first session the same day in most cases.
5. **Remote aftercare.** After you return home, follow-up and questions are handled through your messenger or chat.
...
From a snapping rubber band to a pinching feeling, depending on the person. The Lucas pico laser's pulse is about 1,000 times shorter than a nanosecond laser's, so there is less heat build-up and less pain, and numbing cream is applied for about 30 minutes beforehand.
...
Not at LIV. International patients are charged from the same published price list as Korean patients: tattoo removal from KRW 50,000 per area per session, VAT not included, with no surcharge for interpretation.
