...
INSERT INTO inventory_items (name, category, sub_category, specification, unit, current_stock, min_stock, unit_price, supplier, storage_note) VALUES
  ...
  -- 쥬비덤 (수입)
  ('쥬비덤 볼벨라', 'injection', 'filler_juvederm', '-', '실린지', 30, 10, 250000, '엘러간코리아', '유효기한: 27.03.17'),
  ('쥬비덤 볼루마', 'injection', 'filler_juvederm', '-', '실린지', 25, 10, 280000, '엘러간코리아', '유효기한: 27.02.26'),
  ('쥬비덤 볼리프트', 'injection', 'filler_juvederm', '-', '실린지', 24, 10, 260000, '엘러간코리아', '유효기한: 27.03.15'),
  ('쥬비덤 볼룩스', 'injection', 'filler_juvederm', '-', '실린지', 24, 10, 300000, '엘러간코리아', '유효기한: 26.12.22'),
  -- 로리앙 (국프)
