...
export default function UltheraDetail() {
  ...
  return (
    <>
      ...
      <section className="section-gap bg-gradient-to-b from-white to-[#f9f6f3]">
        <div className="container-custom">
          {/* Section Header */}
          <AnimateOnScroll>
            <div className="text-center mb-16">
      ...
      <section className="section-gap bg-gradient-to-b from-background to-white relative overflow-hidden">
              ...
              <Card padding="lg" className="h-full text-center relative overflow-hidden group border-t-2 border-t-[#D4AF37]/30 hover:border-t-[#D4AF37] transition-colors">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-body text-mono-light leading-relaxed">
                    ...
                    2009년 눈썹 리프팅 최초 승인 이후 목, 턱밑, 데콜테까지 적응증이 확대되었습니다.
                  </p>
                </div>
              </Card>
            </StaggerItem>
              ...
              <Card padding="lg" className="h-full text-center relative overflow-hidden group border-t-2 border-t-[#D4AF37]/30 hover:border-t-[#D4AF37] transition-colors">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-body text-mono-light leading-relaxed">
                    ...
                    정확한 깊이에 에너지를 전달하여 안전성과 효과를 동시에 확보합니다.
                  </p>
                </div>
              </Card>
            </StaggerItem>
      ...
      <section className="section-gap bg-gradient-to-b from-secondary/5 to-background relative overflow-hidden">
      ...
      <section className="section-gap bg-white">
        <div className="container-custom">
          <AnimateOnScroll>
            <div className="text-center mb-16">
              <p className="font-serif text-h3 text-primary mb-2">Results Timeline</p>
              <h2 className="text-h1 text-secondary mb-4">콜라겐 재생 타임라인</h2>
              <p className="text-body text-mono-light">
      ...
      <section className="section-gap bg-background relative">
        <div className="absolute top-0 right-0 w-64 h-64 rounded-full bg-[#D4AF37]/5 blur-3xl" />
        <div className="container-custom relative z-10">
          <AnimateOnScroll>
            <div className="text-center mb-16">
              <div className="flex items-center justify-center gap-4 mb-4">
                <div className="w-12 h-px bg-gradient-to-r from-transparent to-[#D4AF37]" />
                <span className="text-xs tracking-[0.3em] text-[#D4AF37] uppercase font-medium">Process</span>
                <div className="w-12 h-px bg-gradient-to-l from-transparent to-[#D4AF37]" />
              </div>
              <p className="font-serif text-h3 text-primary mb-2">Treatment Process</p>
